      ...
      <section className="section bg-gray-50 pt-8 md:pt-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
          <div className="bg-white p-4 rounded-lg shadow-md">
            <h3 className="text-xl font-bold mb-3 text-[#2aaa8a]">Meine Mission</h3>
            <p className="px-2">
          ...
          <div className="bg-white p-4 rounded-lg shadow-md">
            <h3 className="text-xl font-bold mb-3 text-[#2aaa8a]">Meine Werte</h3>
            <p className="px-2">
          ...
          <div className="bg-white p-4 rounded-lg shadow-md">
            <h3 className="text-xl font-bold mb-3 text-[#2aaa8a]">Mein Versprechen</h3>
            <p className="px-2">
