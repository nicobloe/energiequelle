          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start mt-12">
            <div className="h-full">
              <p className="text-lg mb-6">
                Vom ursprünglichen «Abnehm-Konzept» hat sich unsere Stoffwechselkur zu einem ganzheitlichen
                Regenerations- und Präventionskonzept entwickelt. Die Kur bringt folgende Vorteile für dich:
              </p>
